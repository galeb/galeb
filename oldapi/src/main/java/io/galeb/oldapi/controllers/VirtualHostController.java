...
public class VirtualHostController {
    ...
    public ResponseEntity<VirtualHost> getWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<VirtualHost> postWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<VirtualHost> putWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<VirtualHost> deleteWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<VirtualHost> patchWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<VirtualHost> optionsWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<VirtualHost> headWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<VirtualHost> traceWithParam(@PathVariable String param) {
