...
--
-- Dumping data for table `health_check_headers`
--

LOCK TABLES `health_check_headers` WRITE;
/*!40000 ALTER TABLE `health_check_headers` DISABLE KEYS */;
/*!40000 ALTER TABLE `health_check_headers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `target_pools`
--

LOCK TABLES `target_pools` WRITE;
/*!40000 ALTER TABLE `target_pools` DISABLE KEYS */;
/*!40000 ALTER TABLE `target_pools` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `virtualhost_environments` (
  ...
  PRIMARY KEY (`environment_id`,`virtualhost_id`),
  KEY `FK_virtualhost_id` (`virtualhost_id`),
  CONSTRAINT `FK_environment_id` FOREIGN KEY (`environment_id`) REFERENCES `virtualhost` (`id`),
  CONSTRAINT `FK_virtualhost_id` FOREIGN KEY (`virtualhost_id`) REFERENCES `environment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-02 11:55:25
