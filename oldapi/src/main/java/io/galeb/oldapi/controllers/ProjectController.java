...
import io.galeb.oldapi.services.ProjectService;
...
public class ProjectController {
    ...
    public ResponseEntity<Project> getWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<Project> postWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<Project> putWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<Project> deleteWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<Project> patchWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<Project> optionsWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<Project> headWithParam(@PathVariable String param) {
    ...
    public ResponseEntity<Project> traceWithParam(@PathVariable String param) {
