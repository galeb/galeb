...
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@B, 'POOL_VIEW_ALL');
...
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@B, 'RULE_VIEW_ALL');
...
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@B, 'TARGET_VIEW_ALL');
...
SELECT @C:=id FROM rolegroup WHERE rolegroup.name = 'TEAM_DEFAULT';
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'TEAM_VIEW');
COMMIT;
START TRANSACTION;
...
SELECT @C:=id FROM rolegroup WHERE rolegroup.name = 'PROJECT_DEFAULT';
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'PROJECT_VIEW');
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'PROJECT_SAVE_ALL');
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'PROJECT_DELETE');
COMMIT;
START TRANSACTION;
...
SELECT @C:=id FROM rolegroup WHERE rolegroup.name = 'USER_DEFAULT';
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'TEAM_SAVE');
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'TEAM_VIEW');
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'ACCOUNT_SAVE');
INSERT INTO rolegroup_roles (rolegroup_id, role) VALUES (@C, 'ACCOUNT_VIEW');
COMMIT;
