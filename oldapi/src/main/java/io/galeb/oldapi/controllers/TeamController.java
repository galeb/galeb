...
public class TeamController extends AbstractController<Team> {
    ...
    public ResponseEntity<PagedResources<Resource<Team>>> getSearch(@PathVariable("findType") String findType,
    ...
    public ResponseEntity<Resource<Team>> getWithId(@PathVariable String id) {
        return service.getWithId(id, io.galeb.core.entity.Team.class);
    }

    @RequestMapping(method = POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Resource<Team>> post(@RequestBody String body) {
        return service.post(body, io.galeb.core.entity.Team.class);
    }
    ...
    public ResponseEntity<Resource<Team>> putWithId(@PathVariable String id, @RequestBody String body) {
        return service.putWithId(id, body, io.galeb.core.entity.Team.class);
    }
