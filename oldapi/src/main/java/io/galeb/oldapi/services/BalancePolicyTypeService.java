...
public class BalancePolicyTypeService extends AbstractConverterService<BalancePolicyType> {
    ...
    @Override
    public ResponseEntity<PagedResources<Resource<BalancePolicyType>>> get(Class<? extends AbstractEntity> v2entityClass, Map<String, String> queryMap) {
        ...
        final PagedResources<Resource<BalancePolicyType>> pagedResources = new PagedResources<>(v1Resources, metadata, linkProcessor.pagedLinks(getResourceName(), size, page));
