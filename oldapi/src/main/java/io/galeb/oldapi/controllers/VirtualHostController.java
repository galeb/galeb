...
public class VirtualHostController extends AbstractController<VirtualHost> {
    ...
    public ResponseEntity<PagedResources<Resource<VirtualHost>>> get(@RequestParam(value = "size", required = false) Integer size,
                                                                     @RequestParam(value = "page", required = false) Integer page) {
        return service.get(size, page, io.galeb.core.entity.VirtualHost.class);
    }
